...
from transformers.models.speech_encoder_decoder import SpeechEncoderDecoderConfig
...
class WavEmbedModel(PreTrainedModel):
    r"""
    ...
    def __init__(
        ...
        self.ap = AttentionPooling(self.encoder.config.hidden_size)
    ...
    def forward(
        ...
        **kwargs,
        ...
        encoder_hidden_states = self.ap(encoder_outputs[0])
